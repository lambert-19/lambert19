    ...
    <div class="container">
        ...
        <div class="createpost">
            <form method="post" action="" onsubmit="return validatePost()" enctype="multipart/form-data">
                <h2 style=" color:black; font-weight:bold;">Update Status</h2>
                <br>
                ...
                <textarea rows="6" maxlength="400" name="caption"></textarea>
        ...
        $sql = "SELECT posts.post_caption, posts.post_time, posts.post_public, posts.post_by, users.user_firstname,
                ...
                UNION
                SELECT posts.post_caption, posts.post_time, posts.post_public, posts.post_by, users.user_firstname,
                        users.user_lastname, users.user_id, users.user_gender, posts.post_id
                FROM posts
                JOIN users
                ON posts.post_by = users.user_id
